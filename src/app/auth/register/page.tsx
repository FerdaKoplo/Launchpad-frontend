  ...
  return (
    <form onSubmit={handleSubmit((data: RegisterSchema) => registerAccount.mutate(data))} className=" flex flex-col gap-10">
      <div className="flex text-white flex-col justify-center gap-4">
        ...
        <Input {...register("name")} placeholder="Enter your name..." className="placeholder:text-white focus-visible:ring-white focus:ring-white border-white focus-visible:ring-0 focus-visible:ring-offset-0" />
      </div>
      <div className="flex text-white flex-col justify-center gap-4">
      ...
      <div className="flex flex-col gap-4">
        ...
        <Input {...register("password")} placeholder="Enter your password..." className="placeholder:text-white text-white border-white focus-visible:ring-0 focus-visible:ring-offset-0 transition-none" />
      </div>
      <div className="flex flex-col gap-4">
        <Label className="text-white font-bold">Confirm Password</Label>
        <Input {...register("confirm_password")} placeholder="Enter your password..." className="placeholder:text-white text-white border-white focus-visible:ring-0 focus-visible:ring-offset-0 transition-none" />
      </div>
